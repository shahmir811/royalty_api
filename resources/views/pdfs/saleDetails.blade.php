  ...
  <div style="padding-top: 0px; display: inline-block; width: 45%; margin-top: 0px;margin-left:-10px; height: 73px; ">
    <p style="margin: 0px; font-size: 15px;">{{ $sale->customer->name }}</p>
  ...
  <div style="padding-top: 10px; display: inline-block; margin-left: 10px; width: 40%; margin-top: 250px; margin-left: 110px; height: 73px;">
    <p style="margin: 0px; font-size: 14px;">{{ $sale->shipping_location }}</p>
    <p style="margin: 0px; font-size: 14px;">{{ $sale->contact_no }}</p>
    <div style="margin-top: 20px; margin-left: 60px;">
      <p style="margin: 0px; display: inline-block; margin-left: 0px; font-size: 14px; margin-top: 20px;">{{ $sale->sale_invoice_no }}</p>
      <p style="margin: 0px; display: inline-block; margin-left: 145px; font-size: 14px; margin-top: 20px;">{{ $today }}</p>
    </div>
  </div>
  ...
  <div style="margin-top: -60px; height: 73px;">
    ...
    <div style="margin-left: 100px; display: inline-block; width: 30%;">
      <p style="margin: 0px; display: inline-block; margin-left: -15px; font-size: 14px; margin-top: 15px;">
    ...
    <div style="display: inline-block; width: 35%;">
      <p style="margin: 0px; display: inline-block; margin-left: 10px; font-size: 14px; margin-top: 17px;">
        {{ $sale->payment_mode }}
      </p>
    </div>
    ...
    <div style="display: inline-block; width: 15%;">
      <p style="margin: 0px; display: inline-block; margin-left: 0px; font-size: 14px; margin-top: 20px;">
        {{ $sale->user->name }}
      </p>
    </div>
  ...
  <div style="margin-top: -25px; margin-left: 40px; height: 410px; position:relative;top:10px;">
    @if ($sale->sales->count())
          ...
          @endphp
            ...
            <div>
              <p style="display: inline-block; font-size: 14px; width: 20px; margin-top: 0px; margin-bottom: 0px;position:relative;left:-30px">
                {{ $loop->index + 1 }}
              </p>
              <p style="display: inline-block; font-size: 14px; width: 380px; margin-top: 0px; margin-bottom: 0px;">
                {{ $detail->inventory->item->name }}
              </p>
              <p style="display: inline-block; font-size: 14px; width: 50px; margin-top: 0px; margin-bottom: 0px;position:relative;left:-22px">
                {{ number_format($detail->quantity, 2) }}
              </p>
              <p style="display: inline-block; font-size: 14px; width: 70px; margin-top: 0px; margin-bottom: 0px;position:relative;left:-10px">
  ...
  <div style="margin-top: 25px;margin-left: 570px">
    <p style="font-size: 14px;">{{ number_format($sale->total_tax, 2) }}</p>
  </div>
  ...
  <div style="margin-left: 100px; margin-top: -5px; height: 20px;">
    ...
    <div style="display: inline-block; width: 90%;">
      <p style="display: inline-block; font-size: 14px;position:relative;top:6px;left:-30px">
    ...
    <div style="display: inline-block; width: 5%;">
      <p style="display: inline-block; font-size: 14px;position:relative;top:6px;left:-20px">
