  ...
  <body style="background: #fff; font-family: Arial, Helvetica, sans-serif; font-size: 14px">
    <div style="width:650px ; margin: 0 auto; padding: 20px; background: #fff;">
        ...
        <table style="border-collapse: collapse; border: 1px solid #cecece; width: 100%;">
          ...
          <tr>
            <td  valign="middle" style="border: 1px solid #cecece; padding: 3px">Transaction ID</td>
            <td colspan="3"  style="border: 1px solid #cecece;"><input style="display: block; width: 93%; padding: 0.375rem 0.75rem; font-size: 1rem; line-height: 1.5; color: #495057; background-color: #fff; background-clip: padding-box; border: 1px solid #ced4da; border-radius: 0.25rem; transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out; box-sizing: border-box;" type="text" placeholder="Default input" value="{{ $payment->transaction_id }}"></td>
          </tr>
        </table>
